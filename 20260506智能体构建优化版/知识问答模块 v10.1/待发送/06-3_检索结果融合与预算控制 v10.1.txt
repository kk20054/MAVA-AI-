...
def main(args: dict) -> dict:
    ...
    kb_items = _unwrap(first_arg("kb_results", "bks_results", "bks_final_result", "kb_final_result", "bks_result"))
    web_items = _unwrap(first_arg("web_results", "web_final_result", "web_result"))
